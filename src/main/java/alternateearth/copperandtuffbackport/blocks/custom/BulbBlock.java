package alternateearth.copperandtuffbackport.blocks.custom;
        ...
        if (bl != (Boolean) state.get(POWERED)) {
            ...
            if (!(Boolean) state.get(POWERED)) {
                ...
                world.playSound((PlayerEntity) null, pos,
                        (Boolean) blockState.get(LIT) ? ModSounds.BLOCK_COPPER_BULB_TURN_ON
                                : ModSounds.BLOCK_COPPER_BULB_TURN_OFF,
