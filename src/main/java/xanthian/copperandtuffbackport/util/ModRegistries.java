...
public class ModRegistries {
    ...
    private static void registerOxidizable() {
        ...
        OxidizableBlocksRegistry.registerOxidizableBlockPair(ModCopperBlocks.COPPER_GRATE,
                ModCopperBlocks.EXPOSED_COPPER_GRATE);
        OxidizableBlocksRegistry.registerOxidizableBlockPair(ModCopperBlocks.EXPOSED_COPPER_GRATE,
                ModCopperBlocks.WEATHERED_COPPER_GRATE);
        OxidizableBlocksRegistry.registerOxidizableBlockPair(ModCopperBlocks.WEATHERED_COPPER_GRATE,
                ModCopperBlocks.OXIDIZED_COPPER_GRATE);
        OxidizableBlocksRegistry.registerWaxableBlockPair(ModCopperBlocks.COPPER_GRATE,
                ModCopperBlocks.WAXED_COPPER_GRATE);
        OxidizableBlocksRegistry.registerWaxableBlockPair(ModCopperBlocks.EXPOSED_COPPER_GRATE,
                ModCopperBlocks.WAXED_EXPOSED_COPPER_GRATE);
        OxidizableBlocksRegistry.registerWaxableBlockPair(ModCopperBlocks.WEATHERED_COPPER_GRATE,
                ModCopperBlocks.WAXED_WEATHERED_COPPER_GRATE);
        OxidizableBlocksRegistry.registerWaxableBlockPair(ModCopperBlocks.OXIDIZED_COPPER_GRATE,
                ModCopperBlocks.WAXED_OXIDIZED_COPPER_GRATE);

        OxidizableBlocksRegistry.registerOxidizableBlockPair(ModCopperBlocks.COPPER_BULB,
                ModCopperBlocks.EXPOSED_COPPER_BULB);
        OxidizableBlocksRegistry.registerOxidizableBlockPair(ModCopperBlocks.EXPOSED_COPPER_BULB,
                ModCopperBlocks.WEATHERED_COPPER_BULB);
        OxidizableBlocksRegistry.registerOxidizableBlockPair(ModCopperBlocks.WEATHERED_COPPER_BULB,
                ModCopperBlocks.OXIDIZED_COPPER_BULB);
        OxidizableBlocksRegistry.registerWaxableBlockPair(ModCopperBlocks.COPPER_BULB,
                ModCopperBlocks.WAXED_COPPER_BULB);
        OxidizableBlocksRegistry.registerWaxableBlockPair(ModCopperBlocks.EXPOSED_COPPER_BULB,
                ModCopperBlocks.WAXED_EXPOSED_COPPER_BULB);
        OxidizableBlocksRegistry.registerWaxableBlockPair(ModCopperBlocks.WEATHERED_COPPER_BULB,
                ModCopperBlocks.WAXED_WEATHERED_COPPER_BULB);
        OxidizableBlocksRegistry.registerWaxableBlockPair(ModCopperBlocks.OXIDIZED_COPPER_BULB,
