...
public class ModCopperItems {
        ...
        public static final Item COPPER_HORSE_ARMOR = new HorseArmorItem(4, "copper",
                        new FabricItemSettings().maxCount(1));

        // The type-specific attack damage bonus. 3 for swords, 1.5 for shovels, 1 for
        // pickaxes, varying for axes and hoes.
        // This attack damage is combined with the base attack damage of the tool
        // material.
        // Calculated Values:
        // - Sword: 5
        // - Pickaxe: 3
        ...
        // - Shovel: 3.5F
        // - Hoe: 1
        public static final Item COPPER_SWORD = new SwordItem(COPPER_TOOL_MATERIAL, 3,
                        PLAYER_DEFAULT_ATTACK_SPEED_INVERSE + 1.6F, new FabricItemSettings());
        public static final Item COPPER_PICKAXE = new PickaxeItem(COPPER_TOOL_MATERIAL, 1,
                        PLAYER_DEFAULT_ATTACK_SPEED_INVERSE + 1.2F, new FabricItemSettings());
        public static final Item COPPER_AXE = new AxeItem(COPPER_TOOL_MATERIAL, 7,
                        PLAYER_DEFAULT_ATTACK_SPEED_INVERSE + 0.8F, new FabricItemSettings());
        public static final Item COPPER_SHOVEL = new ShovelItem(COPPER_TOOL_MATERIAL, 1.5F,
                        PLAYER_DEFAULT_ATTACK_SPEED_INVERSE + 1F, new FabricItemSettings());
        public static final Item COPPER_HOE = new HoeItem(COPPER_TOOL_MATERIAL, -1,
                        PLAYER_DEFAULT_ATTACK_SPEED_INVERSE + 2F, new FabricItemSettings());

        public static final Item COPPER_NUGGET = new Item(new FabricItemSettings());

        public static final Item COPPER_TORCH = new VerticallyAttachableBlockItem(ModCopperTorch.COPPER_TORCH,
                        ModCopperTorch.COPPER_WALL_TORCH, new FabricItemSettings().fireproof(), Direction.DOWN);
