...
public class ModCopperBlocks {
    ...
    public static final Block COPPER_WALL_TORCH = new WallTorchBlock(ModParticles.COPPER_FLAME, FabricBlockSettings.copyOf(COPPER_TORCH).dropsLike(COPPER_TORCH));
